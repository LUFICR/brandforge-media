...
export const defaultSiteContent: SiteContent = {
    ...
    items: [
      {
        ...
        description: "Complete brand identity design including logo, colors, typography & brand guidelines that make you unforgettable.",
      ...
      },
      {
        ...
        description: "Premium, responsive websites crafted with cutting-edge technology to convert visitors into loyal customers.",
      ...
      },
      {
        ...
        icon: "Share2",
        title: "Social Media",
        description: "Strategic social media management that builds communities, drives engagement, and grows your audience.",
      ...
      },
      {
        ...
        icon: "BarChart3",
        title: "SEO & Analytics",
        description: "Data-driven SEO strategies that boost rankings, increase traffic, and deliver measurable ROI.",
      ...
      },
      {
        ...
        description: "High-performing ad campaigns across Google, Meta & more — optimized for maximum conversions.",
      ...
      },
      {
        ...
        description: "Professional content production — from photography to video and copywriting that tells your story.",
    ...
    projects: [
      {
        ...
        category: "Branding",
        description: "Complete brand overhaul for a tech startup — logo, identity system, and digital presence.",
      ...
      },
      {
        ...
        description: "Social media strategy that grew engagement by 400% in 4 months.",
      ...
      },
      {
        ...
        category: "E-Commerce",
        description: "Premium e-commerce website with seamless shopping experience.",
      ...
      },
      {
        ...
        description: "Full-funnel digital marketing campaign driving 10K+ app downloads.",
      ...
      },
      {
        ...
        category: "Content",
        description: "Viral content campaign for environmental awareness nonprofit.",
  ...
  testimonials: {
    ...
    items: [
      {
        id: "1",
        quote: "BrandForge Media transformed our online presence completely. Our engagement grew 300% in just 3 months. They truly understand digital marketing.",
        name: "Rahul Sharma",
      ...
      {
        id: "2",
        quote: "The team at BrandForge delivered beyond our expectations. Our website redesign led to a 250% increase in conversions. Highly recommended!",
        name: "Priya Patel",
      ...
      {
        id: "3",
        quote: "Working with BrandForge was a game-changer. Their social media strategy helped us reach 50K followers in just 6 months.",
        name: "Amit Kumar",
      ...
      {
        id: "4",
        quote: "Professional, creative, and results-driven. BrandForge Media helped us establish a strong brand identity from scratch.",
        name: "Sneha Reddy",
    ...
    items: [
      {
        ...
        answer: "We offer a comprehensive range of digital marketing services including brand identity design, web development, social media management, SEO optimization, paid advertising, content creation, and digital strategy consulting.",
      },
      {
        id: "2",
        question: "How long does a typical project take?",
        answer: "Project timelines vary based on scope. A logo design takes 3-5 days, brand identity 1-2 weeks, website development 2-4 weeks, and ongoing marketing campaigns are managed monthly. We always provide clear timelines upfront.",
      },
      {
        id: "3",
        question: "What are your pricing plans?",
        answer: "We offer flexible pricing tailored to your business needs. Packages start from affordable basic plans to comprehensive premium packages. Contact us for a free consultation and custom quote.",
      },
      {
        id: "4",
        question: "Do you work with businesses outside India?",
        answer: "Absolutely! While we're based in India, we work with clients globally. Our digital-first approach means we can collaborate seamlessly regardless of location.",
      },
      {
        id: "5",
        question: "What makes BrandForge different from other agencies?",
        answer: "We combine premium design quality with strategic thinking. Every project gets personalized attention, we offer 24/7 support, fast turnaround times, and most importantly — we focus on measurable results, not just aesthetics.",
      },
      {
        id: "6",
        question: "Can you handle ongoing social media management?",
        answer: "Yes! We offer monthly social media management packages that include content creation, posting, engagement management, analytics reporting, and strategy optimization to keep your brand growing consistently.",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        num: "01",
        title: "Discovery",
        description: "We learn about your business, goals, target audience, and competition through in-depth research.",
        icon: "Search",
      ...
      },
      {
        ...
        num: "02",
        title: "Strategy",
        description: "We create a custom growth plan tailored to your unique business needs and market.",
        icon: "Lightbulb",
      ...
      },
      {
        ...
        num: "03",
        title: "Design",
        description: "We craft premium visual assets and digital experiences that captivate your audience.",
        icon: "PenTool",
      ...
      },
      {
        ...
        num: "04",
        title: "Launch",
        description: "We execute, test, and go live — ensuring everything is pixel-perfect and performing.",
        icon: "Rocket",
      ...
      },
      {
        ...
        num: "05",
        title: "Growth",
        description: "We continuously optimize, analyze, and scale results for sustained business growth.",
        icon: "TrendingUp",
